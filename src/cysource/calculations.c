...
{
    "distutils": {
        "name": "cysource.calculations",
        "sources": [
            "calculations.pyx"
        ]
    },
    "module_name": "cysource.calculations"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cysource__calculations
#define __PYX_HAVE_API__cysource__calculations
/* Early includes */
#include "pythread.h"
#include <string.h>
#include <stdlib.h>
...
/* Module declarations from 'cysource.calculations' */
...
static PyObject *__pyx_f_8cysource_12calculations_taillard_acceleration(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_8cysource_12calculations_tie_breaking(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int, int, int, int); /*proto*/
static PyObject *__pyx_f_8cysource_12calculations_calculate_completion_times(__Pyx_memviewslice, __Pyx_memviewslice, int, int, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_8cysource_12calculations_calculate_idle_times(__Pyx_memviewslice, __Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
static struct __pyx_array_obj *__pyx_array_new(PyObject *, Py_ssize_t, char *, char *, char *); /*proto*/
...
#define __Pyx_MODULE_NAME "cysource.calculations"
extern int __pyx_module_is_main_cysource__calculations;
int __pyx_module_is_main_cysource__calculations = 0;

/* Implementation of 'cysource.calculations' */
...
static const char __pyx_k_inserting_job[] = "inserting_job";
...
static const char __pyx_k_processing_times[] = "processing_times";
...
static PyObject *__pyx_n_s_inserting_job;
...
static PyObject *__pyx_n_s_processing_times;
...
static PyObject *__pyx_pf_8cysource_12calculations_taillard_acceleration(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_inserting_job, int __pyx_v_num_machines, int __pyx_v_use_tie_breaking); /* proto */
static PyObject *__pyx_pf_8cysource_12calculations_2calculate_completion_times(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_num_machines, int __pyx_v_return_array); /* proto */
static PyObject *__pyx_pf_8cysource_12calculations_4calculate_idle_times(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_num_machines); /* proto */
...
static PyObject *__pyx_pw_8cysource_12calculations_1taillard_acceleration(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_8cysource_12calculations_taillard_acceleration(__Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_inserting_job, int __pyx_v_num_machines, int __pyx_v_use_tie_breaking, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_e[0x321][61];
  int __pyx_v_q[0x321][61];
  int __pyx_v_f[0x321][61];
  int __pyx_v_ms[0x321];
  int __pyx_v_sequence_length;
  int __pyx_v_best_makespan;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("taillard_acceleration", 0);

  /* "cysource/calculations.pyx":41
 * 
 ...
 * 
 */
  __pyx_t_1 = __Pyx_MemoryView_Len(__pyx_v_sequence); 
  __pyx_v_sequence_length = __pyx_t_1;

  /* "cysource/calculations.pyx":42
 * 	# Initialize some values
 * 	sequence_length = len(sequence)
 * 	iq = sequence_length + 1             # <<<<<<<<<<<<<<
 * 
 * 	# Main Loop
 */
  __pyx_v_iq = (__pyx_v_sequence_length + 1);

  /* "cysource/calculations.pyx":45
 * 
 * 	# Main Loop
 ...
 * 			e[i][0] = 0
 */
  __pyx_t_2 = (__pyx_v_sequence_length + 2);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 1; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "cysource/calculations.pyx":46
 * 	# Main Loop
 * 	for i in range(1, sequence_length + 2):
 * 		if i < sequence_length + 1:             # <<<<<<<<<<<<<<
 * 			e[i][0] = 0
 * 
 */
    __pyx_t_5 = ((__pyx_v_i < (__pyx_v_sequence_length + 1)) != 0);
    if (__pyx_t_5) {

      /* "cysource/calculations.pyx":47
 * 	for i in range(1, sequence_length + 2):
 * 		if i < sequence_length + 1:
 * 			e[i][0] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
      __pyx_v_iq = (__pyx_v_iq - 1);

      /* "cysource/calculations.pyx":51
 * 			# Q index I
 * 			iq = iq - 1
 * 			q[iq][num_machines + 1] = 0             # <<<<<<<<<<<<<<
 * 
 * 		f[i][0] = 0
 */
      ((__pyx_v_q[__pyx_v_iq])[(__pyx_v_num_machines + 1)]) = 0;
 ...
 */
    __pyx_v_jq = (__pyx_v_num_machines + 1);

    /* "cysource/calculations.pyx":56
 * 		jq = num_machines + 1
 * 
 * 		for j in range(1, num_machines + 1):             # <<<<<<<<<<<<<<
 * 			if i == 1:
 * 				e[0][j] = 0
 */
    __pyx_t_6 = (__pyx_v_num_machines + 1);
    __pyx_t_7 = __pyx_t_6;
    for (__pyx_t_8 = 1; __pyx_t_8 < __pyx_t_7; __pyx_t_8+=1) {
      __pyx_v_j = __pyx_t_8;

      /* "cysource/calculations.pyx":57
 * 
 * 		for j in range(1, num_machines + 1):
 * 			if i == 1:             # <<<<<<<<<<<<<<
 * 				e[0][j] = 0
 ...
 * 				# Q Index J
 */
        ((__pyx_v_q[(__pyx_v_sequence_length + 1)])[((__pyx_v_num_machines + 1) - __pyx_v_j)]) = 0;
 ...
 * 				if e[i][j - 1] > e[i - 1][j]:
 */
        __pyx_v_jq = (__pyx_v_jq - 1);

        /* "cysource/calculations.pyx":64
 * 				jq = jq - 1
 * 
 * 				if e[i][j - 1] > e[i - 1][j]:             # <<<<<<<<<<<<<<
 ...
 */
          ...
          __pyx_t_10 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_9 * __pyx_v_sequence.strides[0]) ))) - 1);
          __pyx_t_11 = (__pyx_v_j - 1);
          ((__pyx_v_e[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_e[__pyx_v_i])[(__pyx_v_j - 1)]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_10 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_11 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
        /*else*/ {
          __pyx_t_9 = (__pyx_v_i - 1);
          __pyx_t_11 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_9 * __pyx_v_sequence.strides[0]) ))) - 1);
          __pyx_t_10 = (__pyx_v_j - 1);
          ((__pyx_v_e[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_e[(__pyx_v_i - 1)])[__pyx_v_j]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_11 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_10 * __pyx_v_processing_times.strides[1]) ))));
        }
        __pyx_L10:;

        /* "cysource/calculations.pyx":69
 * 					e[i][j] = e[i - 1][j] + processing_times[sequence[i - 1]-1, j-1]
 * 
 * 				if q[iq][jq + 1] > q[iq + 1][jq]:             # <<<<<<<<<<<<<<
 ...
 * 				else:
 */
        __pyx_t_5 = ((((__pyx_v_q[__pyx_v_iq])[(__pyx_v_jq + 1)]) > ((__pyx_v_q[(__pyx_v_iq + 1)])[__pyx_v_jq])) != 0);
        if (__pyx_t_5) {

          /* "cysource/calculations.pyx":70
 * 
 * 				if q[iq][jq + 1] > q[iq + 1][jq]:
 * 					q[iq][jq] = q[iq][jq + 1] + processing_times[sequence[iq - 1]-1, jq-1]             # <<<<<<<<<<<<<<
 * 				else:
 ...
 */
          __pyx_t_9 = (__pyx_v_iq - 1);
          __pyx_t_10 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_9 * __pyx_v_sequence.strides[0]) ))) - 1);
          __pyx_t_11 = (__pyx_v_jq - 1);
          ((__pyx_v_q[__pyx_v_iq])[__pyx_v_jq]) = (((__pyx_v_q[__pyx_v_iq])[(__pyx_v_jq + 1)]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_10 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_11 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
        /*else*/ {
          __pyx_t_9 = (__pyx_v_iq - 1);
          __pyx_t_11 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_9 * __pyx_v_sequence.strides[0]) ))) - 1);
          __pyx_t_10 = (__pyx_v_jq - 1);
          ((__pyx_v_q[__pyx_v_iq])[__pyx_v_jq]) = (((__pyx_v_q[(__pyx_v_iq + 1)])[__pyx_v_jq]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_11 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_10 * __pyx_v_processing_times.strides[1]) ))));
        }
        __pyx_L11:;
 ...
 */
        __pyx_t_9 = (__pyx_v_inserting_job - 1);
        __pyx_t_10 = (__pyx_v_j - 1);
        ((__pyx_v_f[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_f[__pyx_v_i])[(__pyx_v_j - 1)]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_9 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_10 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
      /*else*/ {
        __pyx_t_10 = (__pyx_v_inserting_job - 1);
        __pyx_t_9 = (__pyx_v_j - 1);
        ((__pyx_v_f[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_e[(__pyx_v_i - 1)])[__pyx_v_j]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_10 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_9 * __pyx_v_processing_times.strides[1]) ))));
      }
      __pyx_L12:;
    }
  }

  /* "cysource/calculations.pyx":82
 *     # Makespam - job k in position i
 ...
 * 	for i in range(1, sequence_length + 2):
 */
  __pyx_v_best_makespan = 0;

  /* "cysource/calculations.pyx":83
 *     # Also save the first position with the optimal makespan
 * 	best_makespan = 0
 * 	best_position = 0             # <<<<<<<<<<<<<<
 * 	for i in range(1, sequence_length + 2):
 ...
 * 			tmp = f[i][j] +	q[i][j]
 */
    (__pyx_v_ms[__pyx_v_i]) = 0;

    /* "cysource/calculations.pyx":86
 * 	for i in range(1, sequence_length + 2):
 * 		ms[i] = 0
 * 		for j in range(1, num_machines + 1):             # <<<<<<<<<<<<<<
 * 			tmp = f[i][j] +	q[i][j]
 ...
 */
      __pyx_t_5 = ((__pyx_v_tmp > (__pyx_v_ms[__pyx_v_i])) != 0);
      if (__pyx_t_5) {

        /* "cysource/calculations.pyx":89
 * 			tmp = f[i][j] +	q[i][j]
 * 			if tmp > ms[i]:
 * 				ms[i] = tmp             # <<<<<<<<<<<<<<
 * 	    # Check best insertion position
 ...
 */
        (__pyx_v_ms[__pyx_v_i]) = __pyx_v_tmp;
 ...
 * 			best_position = i
 */
    __pyx_t_12 = (((__pyx_v_ms[__pyx_v_i]) < __pyx_v_best_makespan) != 0);
    if (!__pyx_t_12) {
    } else {
      __pyx_t_5 = __pyx_t_12;
      goto __pyx_L19_bool_binop_done;
    }
    __pyx_t_12 = ((__pyx_v_best_makespan == 0) != 0);
    __pyx_t_5 = __pyx_t_12;
    __pyx_L19_bool_binop_done:;
    if (__pyx_t_5) {

      /* "cysource/calculations.pyx":92
 * 	    # Check best insertion position
 * 		if ms[i] < best_makespan or best_makespan == 0:
 * 			best_makespan = ms[i]             # <<<<<<<<<<<<<<
 * 			best_position = i
 * 
 */
      __pyx_v_best_makespan = (__pyx_v_ms[__pyx_v_i]);

      /* "cysource/calculations.pyx":93
 * 		if ms[i] < best_makespan or best_makespan == 0:
 * 			best_makespan = ms[i]
 * 			best_position = i             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_t_15 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_int); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __pyx_t_14 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)0x321), ((Py_ssize_t)61)); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 97, __pyx_L1_error)
    ...
    __pyx_t_16 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(((PyObject *)__pyx_t_13), PyBUF_WRITABLE); if (unlikely(!__pyx_t_16.memview)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_DECREF(((PyObject *)__pyx_t_13)); __pyx_t_13 = 0;
    __pyx_t_14 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_int); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_15 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)0x321), ((Py_ssize_t)61)); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    ...
    __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __pyx_t_17 = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(((PyObject *)__pyx_t_13), PyBUF_WRITABLE); if (unlikely(!__pyx_t_17.memview)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_DECREF(((PyObject *)__pyx_t_13)); __pyx_t_13 = 0;
    __pyx_t_15 = __pyx_format_from_typeinfo(&__Pyx_TypeInfo_int); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    __pyx_t_14 = Py_BuildValue((char*) "("  __PYX_BUILD_PY_SSIZE_T  ")", ((Py_ssize_t)0x321)); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_14);
    __pyx_t_13 = __pyx_array_new(__pyx_t_14, sizeof(int), PyBytes_AS_STRING(__pyx_t_15), (char *) "fortran", (char *) __pyx_v_ms);
    if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
    __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
    __pyx_t_18 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(((PyObject *)__pyx_t_13), PyBUF_WRITABLE); if (unlikely(!__pyx_t_18.memview)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_DECREF(((PyObject *)__pyx_t_13)); __pyx_t_13 = 0;
    __pyx_t_15 = __pyx_f_8cysource_12calculations_tie_breaking(__pyx_v_processing_times, __pyx_t_16, __pyx_t_17, __pyx_t_18, __pyx_v_inserting_job, __pyx_v_best_position, __pyx_v_sequence_length, __pyx_v_num_machines); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_15);
    ...
    __pyx_t_4 = __Pyx_PyInt_As_int(__pyx_t_15); if (unlikely((__pyx_t_4 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 97, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
 ...
 */
  ...
  __pyx_t_15 = __Pyx_PyInt_From_int(__pyx_v_best_position); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 98, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_15);
  __pyx_t_14 = __Pyx_PyInt_From_int(__pyx_v_best_makespan); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 98, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_14);
 ...
 */
  ...
  __Pyx_AddTraceback("cysource.calculations.taillard_acceleration", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_8cysource_12calculations_1taillard_acceleration(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8cysource_12calculations_taillard_acceleration[] = "Find the best position to insert a job (lowest makespan time).\n\n\tReference:\n\t\"Some efficient heuristic methods for the flow shop sequencing problem\",\n\tTaillard, E., EJOR 47 (1990), p65-74.\n\n\tArguments:\n\t\tsequence: Numpy array with current solution (job sequence).\n\t\tprocessing_times: Numpy 2d array with processing times.\n\t\tinserting_job: Job to insert (int)\n\t\tnum_machines: Number of machines in this problem (int).\n\t\tuse_tie_breaking: Use tie breaking mechanism (int, 1 or 0)\n\n\tReturns:\n\t\tbest_position: Index for position with min makespan.\n\t\tbest_makespan: Makespan after inserting the job\n\t";
static PyObject *__pyx_pw_8cysource_12calculations_1taillard_acceleration(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_sequence = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_processing_times = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_inserting_job;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("taillard_acceleration (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sequence,&__pyx_n_s_processing_times,&__pyx_n_s_inserting_job,&__pyx_n_s_num_machines,&__pyx_n_s_use_tie_breaking,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_processing_times)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_inserting_job)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_machines)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, 3); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_use_tie_breaking)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, 4); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "taillard_acceleration") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
    ...
    __pyx_v_sequence = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sequence.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_processing_times = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_processing_times.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_inserting_job = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_inserting_job == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_num_machines = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_num_machines == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_use_tie_breaking = __Pyx_PyInt_As_int(values[4]); if (unlikely((__pyx_v_use_tie_breaking == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("taillard_acceleration", 1, 5, 5, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cysource.calculations.taillard_acceleration", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8cysource_12calculations_taillard_acceleration(__pyx_self, __pyx_v_sequence, __pyx_v_processing_times, __pyx_v_inserting_job, __pyx_v_num_machines, __pyx_v_use_tie_breaking);
...
static PyObject *__pyx_pf_8cysource_12calculations_taillard_acceleration(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_inserting_job, int __pyx_v_num_machines, int __pyx_v_use_tie_breaking) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __Pyx_RefNannySetupContext("taillard_acceleration", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_sequence.memview)) { __Pyx_RaiseUnboundLocalError("sequence"); __PYX_ERR(0, 13, __pyx_L1_error) }
  if (unlikely(!__pyx_v_processing_times.memview)) { __Pyx_RaiseUnboundLocalError("processing_times"); __PYX_ERR(0, 13, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_8cysource_12calculations_taillard_acceleration(__pyx_v_sequence, __pyx_v_processing_times, __pyx_v_inserting_job, __pyx_v_num_machines, __pyx_v_use_tie_breaking, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_sequence, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_processing_times, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "cysource/calculations.pyx":103
 * @cython.boundscheck(False)
 * @cython.wraparound(False)
...
static PyObject *__pyx_f_8cysource_12calculations_tie_breaking(__Pyx_memviewslice __pyx_v_processing_times, __Pyx_memviewslice __pyx_v_e, __Pyx_memviewslice __pyx_v_f, __Pyx_memviewslice __pyx_v_ms, int __pyx_v_inserting_job, int __pyx_v_best_position, int __pyx_v_sequence_length, int __pyx_v_num_machines) {
  int __pyx_v_best_makespan;
 ...
 */
  ...
  __pyx_v_best_makespan = (*((int *) ( /* dim=0 */ (__pyx_v_ms.data + __pyx_t_1 * __pyx_v_ms.strides[0]) )));

  /* "cysource/calculations.pyx":131
 * 	# Save best makespan and start idle time of best position with a high value
 * 	best_makespan = ms[best_position]
 * 	itbp = 2000000             # <<<<<<<<<<<<<<
 * 	num_ties = 0
 ...
 */
    __pyx_t_1 = __pyx_v_i;
    __pyx_t_5 = (((*((int *) ( /* dim=0 */ (__pyx_v_ms.data + __pyx_t_1 * __pyx_v_ms.strides[0]) ))) == __pyx_v_best_makespan) != 0);
    if (__pyx_t_5) {

      /* "cysource/calculations.pyx":137
 * 		if ms[i] == best_makespan:
 * 
 * 			it = 0             # <<<<<<<<<<<<<<
 * 			num_ties += 1
 ...
 */
      __pyx_t_5 = ((__pyx_v_i == __pyx_v_sequence_length) != 0);
      if (__pyx_t_5) {

        /* "cysource/calculations.pyx":142
 * 			# If last position in sequence
 * 			if i == sequence_length:
 * 				for j in range(1, num_machines + 1):             # <<<<<<<<<<<<<<
 * 					it += f[sequence_length][j] - e[sequence_length - 1][j] - processing_times[inserting_job - 1,j - 1]
 ...
 */
          ...
          __pyx_t_9 = __pyx_v_j;
          __pyx_t_10 = (__pyx_v_sequence_length - 1);
          __pyx_t_11 = __pyx_v_j;
          __pyx_t_12 = (__pyx_v_inserting_job - 1);
          __pyx_t_13 = (__pyx_v_j - 1);
          __pyx_v_it = (__pyx_v_it + (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_1 * __pyx_v_f.strides[0]) ) + __pyx_t_9 * __pyx_v_f.strides[1]) ))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_e.data + __pyx_t_10 * __pyx_v_e.strides[0]) ) + __pyx_t_11 * __pyx_v_e.strides[1]) )))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_12 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_13 * __pyx_v_processing_times.strides[1]) )))));
        }
 ...
 */
      /*else*/ {
        ...
        __pyx_t_10 = 0;
        ((__pyx_v_fl[__pyx_v_i])[1]) = ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_13 * __pyx_v_f.strides[0]) ) + __pyx_t_12 * __pyx_v_f.strides[1]) ))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_11 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_10 * __pyx_v_processing_times.strides[1]) ))));

        /* "cysource/calculations.pyx":148
 * 			else:
 * 				fl[i][1] = f[i][1] + processing_times[i - 1][0]
 * 				for j in range(2, num_machines + 1):             # <<<<<<<<<<<<<<
 * 					it += f[i][j] - e[i][j] + processing_times[i - 1,j - 1] - processing_times[inserting_job - 1,j - 1]
 ...
 */
          ...
          __pyx_t_14 = (__pyx_v_inserting_job - 1);
          __pyx_t_15 = (__pyx_v_j - 1);
          __pyx_v_it = (__pyx_v_it + ((((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_f.data + __pyx_t_10 * __pyx_v_f.strides[0]) ) + __pyx_t_11 * __pyx_v_f.strides[1]) ))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_e.data + __pyx_t_12 * __pyx_v_e.strides[0]) ) + __pyx_t_13 * __pyx_v_e.strides[1]) )))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_9 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_1 * __pyx_v_processing_times.strides[1]) )))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_14 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_15 * __pyx_v_processing_times.strides[1]) )))));

          /* "cysource/calculations.pyx":150
 * 				for j in range(2, num_machines + 1):
 * 					it += f[i][j] - e[i][j] + processing_times[i - 1,j - 1] - processing_times[inserting_job - 1,j - 1]
 * 					if fl[i][j - 1] - f[i][j] > 0:             # <<<<<<<<<<<<<<
 * 						it += fl[i][j - 1] - f[i][j]
 ...
 */
            ...
            __pyx_t_15 = (__pyx_v_j - 1);
            ((__pyx_v_fl[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_fl[__pyx_v_i])[(__pyx_v_j - 1)]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_14 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_15 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
          /*else*/ {
            ...
            ((__pyx_v_fl[__pyx_v_i])[__pyx_v_j]) = (((__pyx_v_fl[__pyx_v_i])[__pyx_v_j]) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_15 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_14 * __pyx_v_processing_times.strides[1]) ))));
          }
          __pyx_L12:;
        }
      }
 ...
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_16 = __Pyx_PyInt_From_int(__pyx_v_best_position); if (unlikely(!__pyx_t_16)) __PYX_ERR(0, 162, __pyx_L1_error)
 ...
 */
  ...
  __Pyx_AddTraceback("cysource.calculations.tie_breaking", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
static PyObject *__pyx_pw_8cysource_12calculations_3calculate_completion_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_8cysource_12calculations_calculate_completion_times(__Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_num_machines, int __pyx_v_return_array, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_sequence_length;
  int __pyx_v_i;
  int __pyx_v_j;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("calculate_completion_times", 0);

  /* "cysource/calculations.pyx":184
 * 	# int variables
 ...
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_long((__pyx_v_sequence_length + 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_num_machines + 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 187, __pyx_L1_error)
  ...
  __Pyx_GOTREF(__pyx_t_5);
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_n_s_int32) < 0) __PYX_ERR(0, 187, __pyx_L1_error)
  ...
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_3, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 187, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_e = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "cysource/calculations.pyx":189
 * 	cdef int[:,::1] e = zeros((sequence_length+1,num_machines+1), dtype='int32')
 * 
 * 	for i in range(1, sequence_length + 1):             # <<<<<<<<<<<<<<
 * 		e[i,0] = 0
 * 		for j in range(1, num_machines + 1):
 */
  __pyx_t_7 = (__pyx_v_sequence_length + 1);
  __pyx_t_8 = __pyx_t_7;
  for (__pyx_t_9 = 1; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_i = __pyx_t_9;

    /* "cysource/calculations.pyx":190
 * 
 * 	for i in range(1, sequence_length + 1):
 * 		e[i,0] = 0             # <<<<<<<<<<<<<<
 * 		for j in range(1, num_machines + 1):
 ...
 */
    __pyx_t_10 = __pyx_v_i;
    __pyx_t_11 = 0;
    *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_10 * __pyx_v_e.strides[0]) )) + __pyx_t_11)) )) = 0;

    /* "cysource/calculations.pyx":191
 * 	for i in range(1, sequence_length + 1):
 * 		e[i,0] = 0
 * 		for j in range(1, num_machines + 1):             # <<<<<<<<<<<<<<
 * 			if i == 1:
 * 				e[0,j] = 0
 */
    __pyx_t_12 = (__pyx_v_num_machines + 1);
    __pyx_t_13 = __pyx_t_12;
    for (__pyx_t_14 = 1; __pyx_t_14 < __pyx_t_13; __pyx_t_14+=1) {
      __pyx_v_j = __pyx_t_14;

      /* "cysource/calculations.pyx":192
 * 		e[i,0] = 0
 * 		for j in range(1, num_machines + 1):
 * 			if i == 1:             # <<<<<<<<<<<<<<
 * 				e[0,j] = 0
 * 
 */
      __pyx_t_15 = ((__pyx_v_i == 1) != 0);
      if (__pyx_t_15) {

        /* "cysource/calculations.pyx":193
 * 		for j in range(1, num_machines + 1):
 * 			if i == 1:
 * 				e[0,j] = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_11 * __pyx_v_e.strides[0]) )) + __pyx_t_10)) )) = 0;
 ...
 */
      ...
      __pyx_t_15 = (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_10 * __pyx_v_e.strides[0]) )) + __pyx_t_11)) ))) > (*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_16 * __pyx_v_e.strides[0]) )) + __pyx_t_17)) )))) != 0);
      if (__pyx_t_15) {

        /* "cysource/calculations.pyx":196
 * 
 * 			if e[i - 1, j] > e[i, j - 1]:
 * 				e[i, j] = e[i - 1, j] + processing_times[sequence[i - 1]-1, j-1]             # <<<<<<<<<<<<<<
 * 			else:
 ...
 */
        ...
        __pyx_t_11 = (__pyx_v_i - 1);
        __pyx_t_10 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_11 * __pyx_v_sequence.strides[0]) ))) - 1);
        __pyx_t_18 = (__pyx_v_j - 1);
        __pyx_t_19 = __pyx_v_i;
        __pyx_t_20 = __pyx_v_j;
        *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_19 * __pyx_v_e.strides[0]) )) + __pyx_t_20)) )) = ((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_17 * __pyx_v_e.strides[0]) )) + __pyx_t_16)) ))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_10 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_18 * __pyx_v_processing_times.strides[1]) ))));
 ...
 */
      /*else*/ {
        ...
        __pyx_t_18 = (__pyx_v_j - 1);
        __pyx_t_10 = (__pyx_v_i - 1);
        __pyx_t_16 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_10 * __pyx_v_sequence.strides[0]) ))) - 1);
        __pyx_t_17 = (__pyx_v_j - 1);
        __pyx_t_20 = __pyx_v_i;
        __pyx_t_19 = __pyx_v_j;
        *((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_20 * __pyx_v_e.strides[0]) )) + __pyx_t_19)) )) = ((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_11 * __pyx_v_e.strides[0]) )) + __pyx_t_18)) ))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_16 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_17 * __pyx_v_processing_times.strides[1]) ))));
      }
      __pyx_L8:;
    }
  }

  /* "cysource/calculations.pyx":202
 * 
 ...
 * 	else:
 */
  __pyx_t_15 = ((__pyx_v_return_array > 0) != 0);
  if (__pyx_t_15) {

    /* "cysource/calculations.pyx":203
 * 	# Return completion times array or just makespan (integer)
 * 	if return_array > 0:
 * 		return e             # <<<<<<<<<<<<<<
 * 	else:
 ...
 */
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_e, 2, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 203, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
    goto __pyx_L0;
 ...
 */
  /*else*/ {
    __Pyx_XDECREF(__pyx_r);
    __pyx_t_10 = __pyx_v_sequence_length;
    __pyx_t_17 = __pyx_v_num_machines;
    __pyx_t_3 = __Pyx_PyInt_From_int((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_10 * __pyx_v_e.strides[0]) )) + __pyx_t_17)) )))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 205, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_r = __pyx_t_3;
    __pyx_t_3 = 0;
    goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("cysource.calculations.calculate_completion_times", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_8cysource_12calculations_3calculate_completion_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8cysource_12calculations_2calculate_completion_times[] = "Calculate completion times for each job in each machine.\n\n\tArguments:\n\t\tsequence: Numpy array with Current sequence\n\t\tprocessing_times: Numpy 2d array with processing times.\n\t\tnum_machines: Number of machines in this problem.\n\t\treturn_array: If 1 return array with each completition time,\n\t\tif 0 return just an integer with the completion time of the\n\t\tlast job in the last machine.\n\n\tReturns:\n\t\te: 2d array with the completion time of each job in each machine or\n\t\tcompletion time of the last job in the last machine (int)\n\t";
static PyObject *__pyx_pw_8cysource_12calculations_3calculate_completion_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_sequence = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_processing_times = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_num_machines;
  int __pyx_v_return_array;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calculate_completion_times (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sequence,&__pyx_n_s_processing_times,&__pyx_n_s_num_machines,&__pyx_n_s_return_array,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_processing_times)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calculate_completion_times", 1, 4, 4, 1); __PYX_ERR(0, 167, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_machines)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_completion_times", 1, 4, 4, 2); __PYX_ERR(0, 167, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_return_array)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_completion_times", 1, 4, 4, 3); __PYX_ERR(0, 167, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculate_completion_times") < 0)) __PYX_ERR(0, 167, __pyx_L3_error)
      }
    ...
    __pyx_v_sequence = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sequence.memview)) __PYX_ERR(0, 167, __pyx_L3_error)
    __pyx_v_processing_times = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_processing_times.memview)) __PYX_ERR(0, 167, __pyx_L3_error)
    __pyx_v_num_machines = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_num_machines == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 167, __pyx_L3_error)
    __pyx_v_return_array = __Pyx_PyInt_As_int(values[3]); if (unlikely((__pyx_v_return_array == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 167, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculate_completion_times", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 167, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cysource.calculations.calculate_completion_times", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8cysource_12calculations_2calculate_completion_times(__pyx_self, __pyx_v_sequence, __pyx_v_processing_times, __pyx_v_num_machines, __pyx_v_return_array);
...
static PyObject *__pyx_pf_8cysource_12calculations_2calculate_completion_times(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_num_machines, int __pyx_v_return_array) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("calculate_completion_times", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_sequence.memview)) { __Pyx_RaiseUnboundLocalError("sequence"); __PYX_ERR(0, 167, __pyx_L1_error) }
  if (unlikely(!__pyx_v_processing_times.memview)) { __Pyx_RaiseUnboundLocalError("processing_times"); __PYX_ERR(0, 167, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_8cysource_12calculations_calculate_completion_times(__pyx_v_sequence, __pyx_v_processing_times, __pyx_v_num_machines, __pyx_v_return_array, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 167, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pw_8cysource_12calculations_5calculate_idle_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_8cysource_12calculations_calculate_idle_times(__Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_num_machines, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_sequence_length;
  int __pyx_v_i;
  int __pyx_v_j;
  __Pyx_memviewslice __pyx_v_idle_time = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_e = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  size_t __pyx_t_1;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("calculate_idle_times", 0);

  /* "cysource/calculations.pyx":224
 * 	# int variables
 * 	cdef int sequence_length, i, j
 * 	sequence_length = len(sequence)             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 227, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_sequence_length); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 227, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_n_s_int32) < 0) __PYX_ERR(0, 227, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_3); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 227, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 227, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_idle_time = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "cysource/calculations.pyx":230
 * 	cdef int[:,::1] e
 * 
 ...
 */
  __pyx_t_5 = __pyx_f_8cysource_12calculations_calculate_completion_times(__pyx_v_sequence, __pyx_v_processing_times, __pyx_v_num_machines, 1, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 230, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_d_dc_int(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 230, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_e = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "cysource/calculations.pyx":232
 * 	e = calculate_completion_times(sequence, processing_times, num_machines, 1)
 * 
 * 	for i in range(0, sequence_length):             # <<<<<<<<<<<<<<
 ...
 * 		for j in range(1, num_machines + 1):
 */
  __pyx_t_8 = __pyx_v_sequence_length;
  __pyx_t_9 = __pyx_t_8;
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    __pyx_v_i = __pyx_t_10;

    /* "cysource/calculations.pyx":233
 * 
 * 	for i in range(0, sequence_length):
 * 		idle_time[sequence[i] - 1] = 0             # <<<<<<<<<<<<<<
 * 		for j in range(1, num_machines + 1):
 ...
 */
    __pyx_t_11 = __pyx_v_i;
    __pyx_t_12 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_11 * __pyx_v_sequence.strides[0]) ))) - 1);
    *((int *) ( /* dim=0 */ (__pyx_v_idle_time.data + __pyx_t_12 * __pyx_v_idle_time.strides[0]) )) = 0;

    /* "cysource/calculations.pyx":234
 * 	for i in range(0, sequence_length):
 * 		idle_time[sequence[i] - 1] = 0
 * 		for j in range(1, num_machines + 1):             # <<<<<<<<<<<<<<
 * 			idle_time[sequence[i] - 1] += e[i + 1, j] - processing_times[sequence[i]-1, j-1] - e[i, j]
 * 	return idle_time
 */
    __pyx_t_13 = (__pyx_v_num_machines + 1);
    __pyx_t_14 = __pyx_t_13;
    for (__pyx_t_15 = 1; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
      __pyx_v_j = __pyx_t_15;

      /* "cysource/calculations.pyx":235
 * 		idle_time[sequence[i] - 1] = 0
 * 		for j in range(1, num_machines + 1):
 * 			idle_time[sequence[i] - 1] += e[i + 1, j] - processing_times[sequence[i]-1, j-1] - e[i, j]             # <<<<<<<<<<<<<<
 * 	return idle_time
 */
      ...
      __pyx_t_16 = __pyx_v_i;
      __pyx_t_17 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_16 * __pyx_v_sequence.strides[0]) ))) - 1);
      __pyx_t_18 = (__pyx_v_j - 1);
      __pyx_t_19 = __pyx_v_i;
      __pyx_t_20 = __pyx_v_j;
      __pyx_t_21 = __pyx_v_i;
      __pyx_t_22 = ((*((int *) ( /* dim=0 */ (__pyx_v_sequence.data + __pyx_t_21 * __pyx_v_sequence.strides[0]) ))) - 1);
      *((int *) ( /* dim=0 */ (__pyx_v_idle_time.data + __pyx_t_22 * __pyx_v_idle_time.strides[0]) )) += (((*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_11 * __pyx_v_e.strides[0]) )) + __pyx_t_12)) ))) - (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_processing_times.data + __pyx_t_17 * __pyx_v_processing_times.strides[0]) ) + __pyx_t_18 * __pyx_v_processing_times.strides[1]) )))) - (*((int *) ( /* dim=1 */ ((char *) (((int *) ( /* dim=0 */ (__pyx_v_e.data + __pyx_t_19 * __pyx_v_e.strides[0]) )) + __pyx_t_20)) ))));
    }
  }

  /* "cysource/calculations.pyx":236
 * 		for j in range(1, num_machines + 1):
 * 			idle_time[sequence[i] - 1] += e[i + 1, j] - processing_times[sequence[i]-1, j-1] - e[i, j]
 * 	return idle_time             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_idle_time, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 236, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("cysource.calculations.calculate_idle_times", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_idle_time, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_e, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
...
/* Python wrapper */
static PyObject *__pyx_pw_8cysource_12calculations_5calculate_idle_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_8cysource_12calculations_4calculate_idle_times[] = "Calculate idle times for each job in each machine.\n\n\tArguments:\n\t\tsequence: Numpy array with Current sequence\n\t\tprocessing_times: Numpy 2d array with processing times.\n\t\tnum_machines: Number of machines in this problem.\n\n\tReturns:\n\t\tidle_times: Assigned idle time for each job\n\t";
static PyObject *__pyx_pw_8cysource_12calculations_5calculate_idle_times(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_sequence = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_processing_times = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_num_machines;
  int __pyx_lineno = 0;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("calculate_idle_times (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_sequence,&__pyx_n_s_processing_times,&__pyx_n_s_num_machines,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_processing_times)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("calculate_idle_times", 1, 3, 3, 1); __PYX_ERR(0, 210, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_num_machines)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("calculate_idle_times", 1, 3, 3, 2); __PYX_ERR(0, 210, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "calculate_idle_times") < 0)) __PYX_ERR(0, 210, __pyx_L3_error)
      }
    ...
    __pyx_v_sequence = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_sequence.memview)) __PYX_ERR(0, 210, __pyx_L3_error)
    __pyx_v_processing_times = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_processing_times.memview)) __PYX_ERR(0, 210, __pyx_L3_error)
    __pyx_v_num_machines = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_num_machines == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 210, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("calculate_idle_times", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 210, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("cysource.calculations.calculate_idle_times", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8cysource_12calculations_4calculate_idle_times(__pyx_self, __pyx_v_sequence, __pyx_v_processing_times, __pyx_v_num_machines);
...
static PyObject *__pyx_pf_8cysource_12calculations_4calculate_idle_times(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_sequence, __Pyx_memviewslice __pyx_v_processing_times, int __pyx_v_num_machines) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("calculate_idle_times", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_sequence.memview)) { __Pyx_RaiseUnboundLocalError("sequence"); __PYX_ERR(0, 210, __pyx_L1_error) }
  if (unlikely(!__pyx_v_processing_times.memview)) { __Pyx_RaiseUnboundLocalError("processing_times"); __PYX_ERR(0, 210, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_8cysource_12calculations_calculate_idle_times(__pyx_v_sequence, __pyx_v_processing_times, __pyx_v_num_machines, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 210, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cysource.calculations.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cysource.calculations.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cysource.calculations.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cysource.calculations._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"taillard_acceleration", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8cysource_12calculations_1taillard_acceleration, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8cysource_12calculations_taillard_acceleration},
  {"calculate_completion_times", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8cysource_12calculations_3calculate_completion_times, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8cysource_12calculations_2calculate_completion_times},
  {"calculate_idle_times", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8cysource_12calculations_5calculate_idle_times, METH_VARARGS|METH_KEYWORDS, __pyx_doc_8cysource_12calculations_4calculate_idle_times},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "calculations",
    __pyx_k_permutation_flowshop_repository, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_inserting_job, __pyx_k_inserting_job, sizeof(__pyx_k_inserting_job), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_processing_times, __pyx_k_processing_times, sizeof(__pyx_k_processing_times), 0, 0, 1, 1},
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("calculations", __pyx_methods, __pyx_k_permutation_flowshop_repository, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_cysource__calculations) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 2, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cysource.calculations")) {
      if (unlikely(PyDict_SetItemString(modules, "cysource.calculations", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cysource.calculations", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cysource.calculations");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
